...
#    scp v2v_config.h worker@$ip:/home/worker/xiaoshu/Field-aware-Factorization-Machine-mpi/
...
#mpirun -f ./hosts -np $process_number ./ffm_mpi --flagfile=v2v_config.h
/usr/lib64/mpich/bin/mpirun -np $process_number ./ffm_mpi --flagfile=v2v_config.h
